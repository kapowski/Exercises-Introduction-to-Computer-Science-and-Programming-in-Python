...
# Name: jkantypowicz
# Collaborators: Stack Overflow, Github, Google
# Time spent: Too much
    ...
    * After each guess, you should display to the user the 
    ...
    while True:
        ...
        if guess in secret_word and guess not in letters_guessed:
            ...
            warnings -= 1
            if warnings <= 0: guesses_left -= 1
            print('Oops! That is not a valid letter. You can only input a letter from the aphabet. You have', warnings, 'warnings left:', get_guessed_word(secret_word, letters_guessed))
        ...
        if is_word_guessed(secret_word, letters_guessed):
            ...
            x = len(set(secret_word))
            y = int(guesses_left)
            print('Your total score for this game is:', x * y)
            break
...
def match_with_gaps(my_word, other_word):
    ...
    if len(my_word) == len(other_word):
        for index, letter in enumerate(my_word):
            if letter != '_':
                my_word_list.append(index)
                my_word_list.append(letter)
        for index, letter in enumerate(other_word):
            if letter in my_word_list:
                other_word_list.append(index)
                other_word_list.append(letter)
    else:
        return False
    # print(my_word_list)
...
# secret_word = 'ample' 
# letters_guessed = ['a','l','e','m']
# my_word = get_guessed_word(secret_word, letters_guessed)
# other_word = 'ample'
# print(my_word, other_word, match_with_gaps(my_word, other_word))
